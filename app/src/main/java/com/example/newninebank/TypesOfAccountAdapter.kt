...
class TypesOfAccountAdapter: RecyclerView.Adapter<TypesOfAccountAdapter.TypesOfAccountViewHolder>() {
    val typesAsyncDiff = AsyncListDiffer(this,object  : DiffUtil.ItemCallback<TypesOfAccountModel>(){
